let boot_accounts () : (address * address * address * address * address * address * address) =
    let today : timestamp = ("2024-01-05t10:10:10Z" : timestamp) in
    let () = Test.reset_state_at today 8n ([10000000tez; 4000000tez; 4000000tez; 4000000tez; 4000000tez] : tez list) in
